...
public class LogicalRewriterTest extends EasyMockSupport {
	...
	private LogicalOperator testOperator(Iterator<LogicalOperator> iterator, String exOpName) {
		LogicalOperator op = iterator.next();
		String opName = op.getOperatorName();
		assertTrue("Expected " + exOpName + " but instead " + opName, exOpName.equals(opName));
		return op;
	}
	 ...
	 */
	@Test
	public void testReceiveTimeWindowSelectQuery()
	 ...
	 */
	@Test
	public void testReceiveRowWindowSelectQuery()
	throws SchemaMetadataException, TypeMappingException, 
	SourceMetadataException, OptimizationException, AssertionError, 
	SNEEConfigurationException {
		ExtentMetadata mockExtent = createMock(ExtentMetadata.class);
	 ...
	 */
	@Test
	public void testAcquireTimeWindowSelectQueryCombine()
	throws SchemaMetadataException, TypeMappingException, 
	SourceMetadataException, OptimizationException, SNEEConfigurationException, 
	...
	UtilsException {
		...
		LogicalOperator acquireOp = 
			new AcquireOperator(mockExtent, mockSource, boolType);
		LogicalOperator windowOp = 
	 ...
	 */
	@Test
	public void testAcquireTimeWindowSelectQueryDontCombine()
	throws SchemaMetadataException, TypeMappingException, 
	SourceMetadataException, OptimizationException, SNEEConfigurationException, 
	MalformedURLException, MetadataException, UnsupportedAttributeTypeException, 
	TopologyReaderException, SNEEDataSourceException, CostParametersException, SNCBException, 
	 ...
	 */
	@Test
	public void testAcquireRowWindowSelectQueryCombine()
	throws SchemaMetadataException, TypeMappingException, 
	SourceMetadataException, OptimizationException, SNEEConfigurationException, 
	MalformedURLException, MetadataException, UnsupportedAttributeTypeException, 
	TopologyReaderException, SNEEDataSourceException, CostParametersException, SNCBException, 
	 ...
	 */
	@Test
	public void testAcquireRowWindowSelectQueryDontCombine()
	throws SchemaMetadataException, TypeMappingException, 
	SourceMetadataException, OptimizationException, SNEEConfigurationException, 
	MalformedURLException, MetadataException, UnsupportedAttributeTypeException, 
	TopologyReaderException, SNEEDataSourceException, CostParametersException, SNCBException,
	 ...
	 */
	@Test
	public void testTimeWindowJoinQuery()
	throws SchemaMetadataException, TypeMappingException, 
	SourceMetadataException, OptimizationException, AssertionError,
	 ...
	 */
	@Test
	public void testTimeWindowJoinLeftSelectQuery()
	throws SchemaMetadataException, TypeMappingException, 
	SourceMetadataException, OptimizationException, AssertionError, 
	SNEEConfigurationException, SNEECompilerException {
	 ...
	 */
	@Test
	public void testTimeWindowJoinRightSelectQuery()
	throws SchemaMetadataException, TypeMappingException, 
	SourceMetadataException, OptimizationException, AssertionError, 
	SNEEConfigurationException, SNEECompilerException {
	 ...
	 */
	@Test
	public void testAcquireTimeWindowJoinSelectQueryCombine()
	throws SchemaMetadataException, TypeMappingException, 
	SourceMetadataException, OptimizationException, SNEEConfigurationException, 
	MalformedURLException, MetadataException, UnsupportedAttributeTypeException,
	...
	SNCBException, UtilsException, SNEECompilerException {
		...
		LogicalOperator receiveOpLeft = 
			new AcquireOperator(mockExtentLeft, mockSource, boolType);
		LogicalOperator windowOpLeft = 
			new WindowOperator(0, 0, true, 0, 0, receiveOpLeft, boolType);
		LogicalOperator receiveOpRight = 
			new AcquireOperator(mockExtentRight, mockSource, boolType);
		LogicalOperator windowOpRight = 
			new WindowOperator(0, 0, true, 0, 0, receiveOpRight, boolType);
		LogicalOperator joinOp = 
			new JoinOperator(windowOpLeft, windowOpRight, boolType);		
	 ...
	 */
	@Test
	public void testMultiJoinSelectQuery1()
	throws SchemaMetadataException, TypeMappingException, 
	SourceMetadataException, OptimizationException, AssertionError, 
	SNEEConfigurationException, SNEECompilerException {
	 ...
	 */
	@Test
	public void testMultiJoinSelectQuery2()
	throws SchemaMetadataException, TypeMappingException, 
	SourceMetadataException, OptimizationException, AssertionError, 
	SNEEConfigurationException, SNEECompilerException {
