...
implementation {
  ...
  MultihopOscilloscopeC.CtpInfo -> Collector;
  ...
  MultihopOscilloscopeC.CommandServer -> TestDisseminationAppC.CommandServer;
  MultihopOscilloscopeC.StateChanged -> TestDisseminationAppC.StateChanged;
}
