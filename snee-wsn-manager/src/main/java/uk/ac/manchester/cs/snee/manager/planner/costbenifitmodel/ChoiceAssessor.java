...
import uk.ac.manchester.cs.snee.manager.planner.costbenifitmodel.model.EnergyModel;
import uk.ac.manchester.cs.snee.manager.planner.costbenifitmodel.model.EnergyModelOverlay;
import uk.ac.manchester.cs.snee.manager.planner.costbenifitmodel.model.Model;
import uk.ac.manchester.cs.snee.manager.planner.costbenifitmodel.model.TimeModel;
import uk.ac.manchester.cs.snee.manager.planner.costbenifitmodel.model.TimeModelOverlay;
...
public class ChoiceAssessor implements Serializable
{
  ...
  public ChoiceAssessor(SourceMetadataAbstract _metadata, MetadataManager _metadataManager,
                        File outputFolder)
  {
    ChoiceAssessorInitiliser(_metadata, _metadataManager, outputFolder, true);
  }
  
  public ChoiceAssessor(SourceMetadataAbstract _metadata, MetadataManager _metadataManager, 
      File outputFolder, boolean useCostModelForBinaries)
  {
    ChoiceAssessorInitiliser(_metadata, _metadataManager, outputFolder, useCostModelForBinaries);
  }

  private void ChoiceAssessorInitiliser(SourceMetadataAbstract _metadata,
      MetadataManager _metadataManager, File outputFolder, boolean useCostModelForBinaries)
  {
  ...
  TypeMappingException, IOException, CodeGenerationException, SNEEConfigurationException
  {
    ...
    timeModelOverlay.initilise(imageGenerationFolder, _metadataManager, this.useModelForBinaries);
    energyModelOverlay.initilise(imageGenerationFolder, _metadataManager, runningSites, this.useModelForBinaries);
  ...
  OptimizationException, CodeGenerationException, SNEEConfigurationException
  {
    ...
    timeModelOverlay.initilise(imageGenerationFolder, _metadataManager, useModelForBinaries);
    energyModelOverlay.initilise(imageGenerationFolder, _metadataManager, runningSites, useModelForBinaries);
