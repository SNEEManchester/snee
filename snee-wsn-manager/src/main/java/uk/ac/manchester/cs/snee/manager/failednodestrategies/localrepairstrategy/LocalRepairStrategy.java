...
import uk.ac.manchester.cs.snee.manager.failednodestrategies.localrepairstrategy.metasteiner.MetaSteinerTreeException;
...
public class LocalRepairStrategy extends FailedNodeStrategyAbstract
{
  /**
   * serialVersionUID
   */
   ...
   */
  public LocalRepairStrategy(AutonomicManagerImpl autonomicManager, 
         ...
         SNCBException, SNEECompilerException
  {
    ...
    while(routeIterator.hasNext())
    {
     ...
     this.currentQEP.getAgendaIOT().setID("old Agenda");
      ...
      new LocalRepairStrategyUtils(this).outputAgendas(newAgendaIOT, currentQEP.getAgendaIOT(), this.currentQEP.getIOT(), newIOT, choiceFolder);
  ...
  { 
    ...
    new LocalRepairStrategyUtils(this).outputTopologyAsDotFile(partialFolder, 
                                                                     sep + "topology.dot");
    //setup collectors
