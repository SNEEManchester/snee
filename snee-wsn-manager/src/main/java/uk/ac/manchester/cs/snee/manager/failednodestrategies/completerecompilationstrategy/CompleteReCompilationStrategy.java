package uk.ac.manchester.cs.snee.manager.failednodestrategies.completerecompilationstrategy;
...
public class CompleteReCompilationStrategy extends FailedNodeStrategyAbstract 
{
  /**
   * serialVersionUID
   */
  ...
  private File globalFile;
	...
	public CompleteReCompilationStrategy(AutonomicManagerImpl manager, 
