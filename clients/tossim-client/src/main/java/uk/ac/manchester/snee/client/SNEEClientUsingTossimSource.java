...
public class SNEEClientUsingTossimSource extends SNEEClient {

	public SNEEClientUsingTossimSource(String query, 
	...
	public static void main(String[] args) {
		...
		PropertyConfigurator.configure(
				SNEEClientUsingTossimSource.class.
...
//			query = "SELECT seaLevel, \'East\' FROM SeaDefence;";
		...
		try {
			...
			SNEEClientUsingTossimSource client = 
				new SNEEClientUsingTossimSource(query, duration, queryParams, csvFile);
			/* Run SNEEClient */
			client.run();
		} catch (Exception e) {
