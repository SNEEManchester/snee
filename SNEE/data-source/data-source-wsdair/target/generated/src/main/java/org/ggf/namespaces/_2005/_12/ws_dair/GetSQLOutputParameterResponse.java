 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.ggf.org/namespaces/2005/12/WS-DAIR}SQLOutputParameter" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetSQLOutputParameterResponse")
public class GetSQLOutputParameterResponse {

    @XmlElement(name = "SQLOutputParameter", required = true)
