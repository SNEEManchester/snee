...
public class SensornetProjectOperator extends SensornetOperatorImpl {
   ...
   * serialVersionUID
   */
  private static final long serialVersionUID = -5092011493035875701L;

  private static final Logger logger = Logger.getLogger(SensornetProjectOperator.class.getName());
