...
//		props.setProperty(SNEEPropertyNames.INPUTS_COST_PARAMETERS_FILE, "etc/cost-parameters.xml");		
	...
	throws SNEEConfigurationException {
		props.setProperty(SNEEPropertyNames.GENERAL_QEP_IMAGES, "false");
		SNEEProperties.initialise(props);
	...
	throws SNEEConfigurationException {
		props.setProperty(SNEEPropertyNames.GENERAL_QEP_IMAGES, "true");
		props.setProperty(SNEEPropertyNames.GRAPHVIZ_EXE, "/usr/local/bin/dot");
		SNEEProperties.initialise(props);
		assertEquals("true", SNEEProperties.getSetting(SNEEPropertyNames.GENERAL_QEP_IMAGES));
	}
	...
	throws SNEEConfigurationException {
		...
		SNEEProperties.getSetting(SNEEPropertyNames.GENERAL_QEP_IMAGES);
	}
