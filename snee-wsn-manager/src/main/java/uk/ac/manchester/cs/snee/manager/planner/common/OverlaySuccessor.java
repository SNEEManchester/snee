...
public class OverlaySuccessor implements Comparable<OverlaySuccessor>, Serializable
{
  /**
   * serialVersionUID
   */
  ...
  public OverlaySuccessor(SensorNetworkQueryPlan qep,
                          HashMap<String, RunTimeSite> RunTimeSites, 
                          Integer prevAgendaCount,
  ...
  public OverlaySuccessor(Integer prevAgendaCount)
  {
    this.previousAgendaCount = prevAgendaCount;
  }
  ...
  @Override
  public int compareTo(OverlaySuccessor o)
  {
    return 0;
  }
  ...
  public void setLogicalOverlayNetwork(LogicalOverlayNetwork logicalOverlayNetwork)
  {
